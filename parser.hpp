...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    {
      // assignment
      char dummy1[sizeof (AssignmentExprAST*)];

      // block
      char dummy2[sizeof (BlockAST*)];
      ...
      // forstmt
      char dummy4[sizeof (ForStatementAST*)];

      // definition
      char dummy5[sizeof (FunctionAST*)];

      // globalvar
      char dummy6[sizeof (GlobalVariableAST*)];

      // ifstmt
      char dummy7[sizeof (IfStatementAST*)];

      // binding
      // init
      char dummy8[sizeof (InitAST*)];

      // external
      // proto
      char dummy9[sizeof (PrototypeAST*)];

      // program
      // top
      char dummy10[sizeof (RootAST*)];

      // stmt
      char dummy11[sizeof (StatementAST*)];
      ...
      // vardefs
      char dummy15[sizeof (std::vector<InitAST*>)];

      // stmts
      char dummy16[sizeof (std::vector<StatementAST*>)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, AssignmentExprAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const AssignmentExprAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ForStatementAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ForStatementAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, GlobalVariableAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const GlobalVariableAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, IfStatementAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const IfStatementAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, InitAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const InitAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<InitAST*>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<InitAST*>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      case 45: // assignment
        value.template destroy< AssignmentExprAST* > ();
        break;
      ...
      case 60: // forstmt
        value.template destroy< ForStatementAST* > ();
        break;
      ...
      case 41: // globalvar
        value.template destroy< GlobalVariableAST* > ();
        break;

      case 59: // ifstmt
        value.template destroy< IfStatementAST* > ();
        break;

      case 49: // binding
      case 61: // init
        value.template destroy< InitAST* > ();
        break;
      ...
      case 47: // vardefs
        value.template destroy< std::vector<InitAST*> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_SEMICOLON || tok == token::TOK_COMMA || tok == token::TOK_DMINUS || tok == token::TOK_MINUS || tok == token::TOK_DPLUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_QMARK || tok == token::TOK_COLON || tok == token::TOK_LT || tok == token::TOK_GT || tok == token::TOK_EQ || tok == token::TOK_ASSIGN || tok == token::TOK_LSQRBRACE || tok == token::TOK_RSQRBRACE || tok == token::TOK_LBRACE || tok == token::TOK_RBRACE || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_NOT || tok == token::TOK_EXTERN || tok == token::TOK_DEF || tok == token::TOK_GLOBAL || tok == token::TOK_VAR || tok == token::TOK_IF || tok == token::TOK_ELSE || tok == token::TOK_FOR || tok == 290);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_DMINUS (location_type l)
      {
        return symbol_type (token::TOK_DMINUS, std::move (l));
      }
#else
      static
      symbol_type
      make_DMINUS (const location_type& l)
      {
        return symbol_type (token::TOK_DMINUS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_DPLUS (location_type l)
      {
        return symbol_type (token::TOK_DPLUS, std::move (l));
      }
#else
      static
      symbol_type
      make_DPLUS (const location_type& l)
      {
        return symbol_type (token::TOK_DPLUS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LSQRBRACE (location_type l)
      {
        return symbol_type (token::TOK_LSQRBRACE, std::move (l));
      }
#else
      static
      symbol_type
      make_LSQRBRACE (const location_type& l)
      {
        return symbol_type (token::TOK_LSQRBRACE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RSQRBRACE (location_type l)
      {
        return symbol_type (token::TOK_RSQRBRACE, std::move (l));
      }
#else
      static
      symbol_type
      make_RSQRBRACE (const location_type& l)
      {
        return symbol_type (token::TOK_RSQRBRACE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    ...
    {
      case 45: // assignment
        value.move< AssignmentExprAST* > (std::move (that.value));
        break;
      ...
      case 60: // forstmt
        value.move< ForStatementAST* > (std::move (that.value));
        break;
      ...
      case 41: // globalvar
        value.move< GlobalVariableAST* > (std::move (that.value));
        break;

      case 59: // ifstmt
        value.move< IfStatementAST* > (std::move (that.value));
        break;

      case 49: // binding
      case 61: // init
        value.move< InitAST* > (std::move (that.value));
        break;
      ...
      case 47: // vardefs
        value.move< std::vector<InitAST*> > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    ...
    {
      case 45: // assignment
        value.copy< AssignmentExprAST* > (YY_MOVE (that.value));
        break;
      ...
      case 60: // forstmt
        value.copy< ForStatementAST* > (YY_MOVE (that.value));
        break;
      ...
      case 41: // globalvar
        value.copy< GlobalVariableAST* > (YY_MOVE (that.value));
        break;

      case 59: // ifstmt
        value.copy< IfStatementAST* > (YY_MOVE (that.value));
        break;

      case 49: // binding
      case 61: // init
        value.copy< InitAST* > (YY_MOVE (that.value));
        break;
      ...
      case 47: // vardefs
        value.copy< std::vector<InitAST*> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 45: // assignment
        value.move< AssignmentExprAST* > (YY_MOVE (s.value));
        break;
      ...
      case 60: // forstmt
        value.move< ForStatementAST* > (YY_MOVE (s.value));
        break;
      ...
      case 41: // globalvar
        value.move< GlobalVariableAST* > (YY_MOVE (s.value));
        break;

      case 59: // ifstmt
        value.move< IfStatementAST* > (YY_MOVE (s.value));
        break;

      case 49: // binding
      case 61: // init
        value.move< InitAST* > (YY_MOVE (s.value));
        break;
      ...
      case 47: // vardefs
        value.move< std::vector<InitAST*> > (YY_MOVE (s.value));
        break;
